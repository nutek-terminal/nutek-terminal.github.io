...
menu:
  docs:
    parent: "know"
    identifier: "gobuster-ba439a335ffe0b4263f563183e20cdde"
weight: 999
toc: true
---
# gobuster
...
Gobuster is a tool used to brute-force URIs (directories and files) in web sites, DNS subdomains (with wildcard support), Virtual Host names on target web servers and Virtual Host names on target web servers.
