...
menu:
  docs:
    parent: "know"
    identifier: "nmap-23e10671ecf052f43c6d9177da00ede5"
weight: 999
toc: true
---
...
DESCRIPTION
       ...
       newest version of this help is available at
...
TARGET SPECIFICATION
       ...
       Scan each IP address only once. The default behavior is to scan
...
PORT SCANNING TECHNIQUES
       ...
       vendors simply paged through the Nmap help adding specific
       rules!
...
TIMING AND PERFORMANCE
       ...
       used to override the T5 timing template, which sets the host
       ...
       TCP and SCTP scan delay to 10ms.  T5 does the equivalent of
       --max-rtt-timeout 300ms --min-rtt-timeout 50ms
       --initial-rtt-timeout 250ms --max-retries 2 --host-timeout 15m
       --script-timeout 10m --max-scan-delay as well as setting the
       maximum TCP and SCTP scan delay to 5ms. Maximum UDP scan delay is
       not set by T4 or T5, but it can be set with the --max-scan-delay
       option.
...
FIREWALL/IDS EVASION AND SPOOFING
       ...
       IP options with Nmap, see https://seclists.org/nmap-dev/2006/q3/52.
       ...
       parameters accordingly. In particular, a lower --max-parallelism
       may help because some proxies refuse to handle as many concurrent
...
OUTPUT
       ...
       As with XML output, this help does not allow for documenting
...
LEGAL NOTICES
   Nmap Copyright and Licensing
       ...
       Nmap to be used and redistributed within commercial software or
   ...
   Source Code Availability and Community Contributions
       ...
       KDE and NASM). We also sell commercial licenses to Nmap OEM[21]. If you
   ...
   Third-Party Software and Funding Notices
       ...
       version of the Lua programming language[28].  The Liblinear linear
       classification library[29] is used for our IPv6 OS detection machine
       ...
       Code[31] and the DARPA CINDER program[32] (DARPA-BAA-10-84).
   ...
   United States Export Control
       ...
       Administration Regulations (EAR)[33] export control. As such, there is
       ...
       Nmap Project believes that Nmap falls under U.S. ECCN 5D002[34]
